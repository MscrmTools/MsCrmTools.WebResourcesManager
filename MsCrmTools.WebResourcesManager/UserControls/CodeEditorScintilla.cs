...
namespace MscrmTools.WebResourcesManager.UserControls
{
    public partial class CodeEditorScintilla : UserControl, IWebResourceControl
    {
        ...
        {
            scintilla.Text = originalContent;
        ...
        private void Comment(bool comment)
        {
            ...
            else if (innerType == Enumerations.WebResourceType.Css)
            {
            ...
            else if (innerType == Enumerations.WebResourceType.WebPage
                || innerType == Enumerations.WebResourceType.Data
